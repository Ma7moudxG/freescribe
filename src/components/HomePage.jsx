...
export default function HomePage(props) {
  ...
  return (
    <main className="flex-1 p-4 flex flex-col 
        text-center gap-3 sm:gap-4 
        pb-20 justify-center">
        ...
        <button onClick={ recordingStatus === 'recording' ? 
            ...
            gap-4 mx-auto width-72 max-w-full my-4 ' >
            ...
            <i className={'duration-200 fa-solid fa-microphone ' + 
                (recordingStatus === 'recording' ? ' text-rose-300' : "")}>
            </i>
        </button>

        <p className='text-base'>Or
            <label className='text-blue-400 cursor-pointer hover:text-blue-600 
                duration-200'> Upload 
                <input onChange={(e) => {
